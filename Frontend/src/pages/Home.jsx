...
function Home() {
  return (
    	...
    	<div class="container">
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 d-flex">
    				<div class="img d-flex align-items-center justify-content-center py-5 py-md-0" style={{backgroundImage: "url('/assets/images/about.jpg')"}}>
    			...
    			<div class="col-md-6 pl-md-5 pt-md-5">
		          ...
		          <div>
		            <div class="block-18">
		              <div class="text">
		                <strong class="number" data-number="45">5</strong>
		              </div>
		              <div class="text">
		          ...
		          <div className='mx-4'>
		            <div class="block-18">
		              <div class="text">
		                <strong class="number" data-number="2342">600</strong>
		              </div>
		              <div class="text">
		          ...
		          <div className='mx-2'>
		            <div class="block-18">
		              <div class="text">
		                <strong class="number" data-number="30">450</strong>
		              </div>
		              <div class="text">
    ...
    <section className='ftco-section'>
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-lg-3 pr-md-4 pb-lg-0 pb-4">
						<div class="heading-section  text-center text-lg-left">
        ...
        backgroundImage: "url('/assets/images/staff-1.jpg')", // Update path as needed
        ...
        minHeight: '100vh'
					...
					<div class="col-md-4 col-lg-3  d-flex">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style={{
        backgroundImage: "url('/assets/images/staff-2.jpg')", // Update path as needed
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        minHeight: '100vh'
      }} ></div>
					...
					<div class="col-md-4 col-lg-3  d-flex">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style={{
        backgroundImage: "url('/assets/images/staff-3.jpg')", // Update path as needed
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        minHeight: '100vh'
      }}></div>
      ...
      <div class="container">
        ...
        backgroundImage: "url('/assets/images/person_1.jpg')", // Update path as needed
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        minHeight: '20vh',
        minWidth: '20vh'
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                  	<div class="d-flex align-items-center mb-4">
                    	<div class="user-img" style={{
        backgroundImage: "url('/assets/images/person_4.jpg')", // Update path as needed
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        minHeight: '20vh',
        minWidth: '20vh'
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                  	<div class="d-flex align-items-center mb-4">
                    	<div class="user-img" style={{
        backgroundImage: "url('/assets/images/person_3.jpg')", // Update path as needed
        backgroundSize: 'cover',
        backgroundPosition: 'center',
         minHeight: '20vh',
        minWidth: '20vh'
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                  	<div class="d-flex align-items-center mb-4">
                    	<div class="user-img" style={{
        backgroundImage: "url('/assets/images/person_2.jpg')", // Update path as needed
        backgroundSize: 'cover',
        backgroundPosition: 'center',
         minHeight: '20vh',
        minWidth: '20vh'
    ...
    <section class="ftco-section ftco-no-pb">
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center" style={{
        backgroundImage: "url('/assets/images/work-1.jpg')"}}>
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center"  style={{
        backgroundImage: "url('/assets/images/work-2.jpg')"}}>
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center"  style={{
        backgroundImage: "url('/assets/images/work-3.jpg')"}}>
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center" style={{
        backgroundImage: "url('/assets/images/work-4.jpg')"}}>
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center"  style={{
        backgroundImage: "url('/assets/images/work-5.jpg')"}}>
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center"  style={{
        backgroundImage: "url('/assets/images/work-6.jpg')"}}>
          ...
          <div class="col-md-6 col-lg-3 ">
            <div class="work img d-flex align-items-center"  style={{
        backgroundImage: "url('/assets/images/work-7.jpg')"}}>
      ...
      <div class="container">
        ...
        backgroundImage: "url('/assets/images/image_1.jpg')"}}>
              ...
              <div class="text mt-3 px-4">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style={{
        backgroundImage: "url('/assets/images/person_2.jpg')"}}></div>
              		<div class="desc pl-3">
        ...
        backgroundImage: "url('/assets/images/image_2.jpg')"}}>
              ...
              <div class="text mt-3 px-4">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style={{
        backgroundImage: "url('/assets/images/person_3.jpg')"}}></div>
              		<div class="desc pl-3">
              			<span>Posted by John doe</span>
              			<span>04 March 2020</span>
              		</div>
        ...
        backgroundImage: "url('/assets/images/image_3.jpg')"}}>
              ...
              <div class="text mt-3 px-4">
              	<div class="posted mb-3 d-flex">
              		<div class="img author" style={{
        backgroundImage: "url('/assets/images/person_1.jpg')"}}></div>
              		<div class="desc pl-3">
              			<span>Posted by John doe</span>
              			<span>04 March 2020</span>
              		</div>
    ...
    <section class="ftco-section ftco-intro" style={{
        backgroundImage: "url('/assets/images/bg_3.jpg')"}} data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section bg-light">
        ...
        <footer class="footer ftco-section">
			<div class="container">
              ...
              <a class="img mr-4 rounded" style={{
        backgroundImage: "url('/assets/images/image_2.jpg')"}}></a>
              <div class="text">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="img mr-4 rounded" style={{
        backgroundImage: "url('/assets/images/image_1.jpg')"}}></a>
              <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> Mar. 04, 2020</a></div>
              ...
              <ul>
                <li><span class="icon fa fa-map-marker"></span><span class="text">Sparkle Cleaning, Gandipuram, Coimbatore.</span></li>
